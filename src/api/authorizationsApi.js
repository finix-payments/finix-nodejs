...
class AuthorizationsApi {
     ...
     */
    async createHelper(createAuthorizationRequest, options = { headers: {} }) {
        ...
        let localVarRequestOptions = {
            ...
            json: true,
            body: models_1.ObjectSerializer.serialize(createAuthorizationRequest, "CreateAuthorizationRequest")
        };
     ...
     */
    async getHelper(authorizationId, options = { headers: {} }) {
    ...
    */
    async listHelper(listAuthorizationsQueryParams, options = { headers: {} }) {
        const localVarPath = this.basePath + '/authorizations';
        let localVarQueryParameters = {};
        let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
        const produces = ['application/hal+json'];
    ...
    */
     ...
     */
    async updateHelper(authorizationId, updateAuthorizationRequest, options = { headers: {} }) {
        const localVarPath = this.basePath + '/authorizations/{authorization_id}'
            .replace('{' + 'authorization_id' + '}', encodeURIComponent(String(authorizationId)));
        let localVarQueryParameters = {};
        let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
        ...
        let localVarRequestOptions = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: models_1.ObjectSerializer.serialize(updateAuthorizationRequest, "UpdateAuthorizationRequest")
        };
        let authenticationPromise = Promise.resolve();
        if (this.authentications.BasicAuth.username && this.authentications.BasicAuth.password) {
            authenticationPromise = authenticationPromise.then(() => this.authentications.BasicAuth.applyToRequest(localVarRequestOptions));
