...
export class MerchantsApi {
    ...
    private async createHelper(identityId: string, createMerchantUnderwritingRequest?: CreateMerchantUnderwritingRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Merchant;  }> {
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(createMerchantUnderwritingRequest, "CreateMerchantUnderwritingRequest")
        };
    ...
    public async create(identityId: string, createMerchantUnderwritingRequest?: CreateMerchantUnderwritingRequest, options: {headers: {[name: string]: string}} = {headers: {}}, httpData?: Boolean = false) : 
        Promise<Merchant| {response: http.IncomingMessage; body: Merchant; }| {response: http.IncomingMessage; body: SuperSet<any>;}> {
    ...
    */
    public async list (listMerchantsQueryParams?:ListMerchantsQueryParams, options: {headers: {[name: string]: string}} = {headers: {}}, httpData?: Boolean = false) :
        Promise<MerchantsList| {response: http.IncomingMessage; body: MerchantsList; }| {response: http.IncomingMessage; body: SuperSet<any>;}> {
    ...
    private async updateHelper(merchantId: string, updateMerchantRequest?: UpdateMerchantRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Merchant;  }> {
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(updateMerchantRequest, "UpdateMerchantRequest")
        };
